...
# Batch: find /home/laser/rawdata/als/ -wholename "*/las/*.la[sz]" -exec sh /home/klaus/private/ba/tools/get_lasinfo.sh {} \; &
# Batch: find /home/laser/rawdata/als/ -wholename "*/las/*.la[sz]" -exec sh /home/klaus/private/ba/tools/get_lasinfo.sh {} rebuild \; &
#

#
# handle logging
#
CSV=/home/klaus/private/ba/tools/logs/get_lasinfo.csv
if [ ! -f "$CSV" ]; then
