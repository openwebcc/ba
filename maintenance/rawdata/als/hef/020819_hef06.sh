...
mkdir -pv /home/laser/rawdata/als/hef/020819_hef06/{asc,las,bet,doc,meta}

# Rohdaten und Dokumentation kopieren
cd /home/laser/rawdata/als/hef/020819_hef06
cp -avu /mnt/netappa/Rohdaten/hef/hef06_020819/kach/all/*.all ./asc/
...
cd /home/laser/rawdata/als/hef/020819_hef06/asc/
for ALL in `ls *.all`
do
