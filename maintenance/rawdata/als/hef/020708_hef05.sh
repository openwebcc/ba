#!/bin/sh
#
# Datenmigration: Befliegung Hintereisferner, 08.07.2002
#

# Ordnerstruktur erstellen
mkdir -pv /home/laser/rawdata/als/hef/020708_hef05/{asc,las,bet,doc,meta}

# Rohdaten und Dokumentation kopieren
cd /home/laser/rawdata/als/hef/020708_hef05
cp -avu /mnt/netappa/Rohdaten/hef/hef05_020708/kach/all/*.all ./asc/
...
cd /home/laser/rawdata/als/hef/020708_hef05/asc/
for ALL in `ls *.all`
do
