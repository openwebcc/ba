#!/bin/sh
#
# Datenmigration: Befliegung Hintereisferner, 07.05.2002
#

# Ordnerstruktur erstellen
mkdir -pv /home/laser/rawdata/als/hef/020507_hef03/{asc,las,bet,doc,meta}

# Rohdaten und Dokumentation kopieren
cd /home/laser/rawdata/als/hef/020507_hef03
cp -avu /mnt/netappa/Rohdaten/hef/hef03_020507/kach/all/*.all ./asc/
...
cd /home/laser/rawdata/als/hef/020507_hef03/asc/
for ALL in `ls *.all`
do
