...
# Batch: find /home/rawdata/als/ -wholename "*/las/*.la[sz]" -exec sh /home/institut/rawdata/maintenance/scripts/als/get_hull.sh {} 10 \; &
# Batch: find /home/rawdata/als/ -wholename "*/las/*.la[sz]" -exec sh /home/institut/rawdata/maintenance/scripts/als/get_hull.sh {} 10 rebuild \; &
#

#
# handle logging
#
CSV=/home/institut/rawdata/maintenance/scripts/als/logs/get_hull.csv
if [ ! -f "$CSV" ]; then
